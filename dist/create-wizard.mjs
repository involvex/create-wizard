...
var debugTestSetup = (0, import_debug.default)("create-wizard:create-test-setup");
...
if (isDebugEnabled) {
  import_debug2.default.enable("create-wizard:*");
  console.log("Debug logging enabled for create-wizard");
}
var debugLog = (0, import_debug2.default)("create-wizard:create-app");
var debugTemplates = (0, import_debug2.default)("create-wizard:create-app:templates");
var debugTemplatesApply = (0, import_debug2.default)("create-wizard:create-app:apply");
var debugDeps = (0, import_debug2.default)("create-wizard:create-app:deps");
var debugGit = (0, import_debug2.default)("create-wizard:create-app:git");
if (isDebugEnabled) {
...
async function main4(deps) {
  ...
  async function getTemplates() {
    ...
    try {
      const templatesPath = join4(dirname(fileURLToPath4(import.meta.url)), "..", "template-library");
  ...
  const answers = await inquirer2.prompt([
    ...
    },
    {
      ...
      choices: ["Jest", "Vitest", "Mocha/Chai"],
      when: (answers2) => answers2.includeTestFramework
    },
    {
      type: "confirm",
