...
(function(e2) {
  ...
  u3.length = function(F2) {
    ...
    for (var D2 = "", C2 = 0, n2 = t(F2), E = 0; E < n2.length; E++) {
      ...
      if (C2 >= s - (o3 == 2 ? 1 : 0)) if (C2 + o3 <= i2) D2 += a2;
      else break;
      C2 += o3;
    }
    return D2;
...
var R = (e2 = 0) => (u3, t, F2) => `\x1B[${38 + e2};2;${u3};${t};${F2}m`;
...
var k = (e2, u3, t) => {
  ...
  for (const [C2, n2] of F2.entries()) {
    const E = p(n2);
    if (D2 + E <= t ? e2[e2.length - 1] += n2 : (e2.push(n2), D2 = 0), d.has(n2) && (s = true, i2 = F2.slice(C2 + 1).join("").startsWith(_)), s) {
...
function fD({ input: e2 = j, output: u3 = M, overwrite: t = true, hideCursor: F2 = true } = {}) {
  const s = g.createInterface({ input: e2, output: u3, prompt: "", tabSize: 1 });
  ...
  return F2 && u3.write(import_sisteransi.cursor.hide), e2.once("keypress", i2), () => {
    e2.off("keypress", i2), F2 && u3.write(import_sisteransi.cursor.show), e2.isTTY && !AD && e2.setRawMode(false), s.terminal = false, s.close();
  };
}
var gD = Object.defineProperty;
var vD = (e2, u3, t) => u3 in e2 ? gD(e2, u3, { enumerable: true, configurable: true, writable: true, value: t }) : e2[u3] = t;
var h2 = (e2, u3, t) => (vD(e2, typeof u3 != "symbol" ? u3 + "" : u3, t), t);
var x = class {
  constructor(u3, t = true) {
    ...
    const { input: F2 = j, output: s = M, render: i2, signal: D2, ...C2 } = u3;
  ...
  onKeypress(u3, t) {
    ...
    $2([u3, t?.name, t?.sequence], "cancel") && (this.state = "cancel"), (this.state === "submit" || this.state === "cancel") && this.emit("finalize"), this.render(), (this.state === "submit" || this.state === "cancel") && this.close();
  }
  close() {
...
var $D = (e2, u3, t) => u3 in e2 ? kD(e2, u3, { enumerable: true, configurable: true, writable: true, value: t }) : e2[u3] = t;
var H = (e2, u3, t) => ($D(e2, typeof u3 != "symbol" ? u3 + "" : u3, t), t);
...
var PD = (e2, u3, t) => u3 in e2 ? OD(e2, u3, { enumerable: true, configurable: true, writable: true, value: t }) : e2[u3] = t;
var J = (e2, u3, t) => (PD(e2, typeof u3 != "symbol" ? u3 + "" : u3, t), t);
...
var G2 = (t) => {
  const { cursor: n2, options: r2, style: i2 } = t, s = t.maxItems ?? Number.POSITIVE_INFINITY, c3 = Math.max(process.stdout.rows - 4, 0), a2 = Math.min(c3, Math.max(s, 5));
  let l2 = 0;
  n2 >= l2 + a2 - 3 ? l2 = Math.max(Math.min(n2 - a2 + 3, r2.length - a2), 0) : n2 < l2 + 2 && (l2 = Math.max(n2 - 2, 0));
  const $3 = a2 < r2.length && l2 > 0, g2 = a2 < r2.length && l2 + a2 < r2.length;
...
`, r2 = t.placeholder ? import_picocolors2.default.inverse(t.placeholder[0]) + import_picocolors2.default.dim(t.placeholder.slice(1)) : import_picocolors2.default.inverse(import_picocolors2.default.hidden("_")), i2 = this.value ? this.valueWithCursor : r2;
  switch (this.state) {
    case "error":
      return `${n2.trim()}
${import_picocolors2.default.yellow(o2)}  ${i2}
${import_picocolors2.default.yellow(d2)}  ${import_picocolors2.default.yellow(this.error)}
`;
    case "submit":
      return `${n2}${import_picocolors2.default.gray(o2)}  ${import_picocolors2.default.dim(this.value || t.placeholder)}`;
    case "cancel":
...
${import_picocolors2.default.gray(o2)}` : ""}`;
    default:
      return `${n2}${import_picocolors2.default.cyan(o2)}  ${i2}
...
var ye = (t) => {
  ...
  return new dD({ active: n2, inactive: r2, initialValue: t.initialValue ?? true, render() {
    const i2 = `${import_picocolors2.default.gray(o2)}
${b2(this.state)}  ${t.message}
`, s = this.value ? n2 : r2;
    switch (this.state) {
      case "submit":
        return `${i2}${import_picocolors2.default.gray(o2)}  ${import_picocolors2.default.dim(s)}`;
      case "cancel":
        return `${i2}${import_picocolors2.default.gray(o2)}  ${import_picocolors2.default.strikethrough(import_picocolors2.default.dim(s))}
${import_picocolors2.default.gray(o2)}`;
      default:
        return `${i2}${import_picocolors2.default.cyan(o2)}  ${this.value ? `${import_picocolors2.default.green(k2)} ${n2}` : `${import_picocolors2.default.dim(P2)} ${import_picocolors2.default.dim(n2)}`} ${import_picocolors2.default.dim("/")} ${this.value ? `${import_picocolors2.default.dim(P2)} ${import_picocolors2.default.dim(r2)}` : `${import_picocolors2.default.green(k2)} ${r2}`}
${import_picocolors2.default.cyan(d2)}
`;
    }
  } }).prompt();
...
var ve = (t) => {
  ...
  return new LD({ options: t.options, initialValue: t.initialValue, render() {
    const r2 = `${import_picocolors2.default.gray(o2)}
${b2(this.state)}  ${t.message}
`;
    switch (this.state) {
      case "submit":
        return `${r2}${import_picocolors2.default.gray(o2)}  ${n2(this.options[this.cursor], "selected")}`;
      case "cancel":
        return `${r2}${import_picocolors2.default.gray(o2)}  ${n2(this.options[this.cursor], "cancelled")}
${import_picocolors2.default.gray(o2)}`;
      default:
        return `${r2}${import_picocolors2.default.cyan(o2)}  ${G2({ cursor: this.cursor, options: this.options, maxItems: t.maxItems, style: (i2, s) => n2(i2, s ? "active" : "inactive") }).join(`
...
var fe = (t) => {
  const n2 = (r2, i2) => {
    const s = r2.label ?? String(r2.value);
    return i2 === "active" ? `${import_picocolors2.default.cyan(A2)} ${s} ${r2.hint ? import_picocolors2.default.dim(`(${r2.hint})`) : ""}` : i2 === "selected" ? `${import_picocolors2.default.green(T)} ${import_picocolors2.default.dim(s)} ${r2.hint ? import_picocolors2.default.dim(`(${r2.hint})`) : ""}` : i2 === "cancelled" ? `${import_picocolors2.default.strikethrough(import_picocolors2.default.dim(s))}` : i2 === "active-selected" ? `${import_picocolors2.default.green(T)} ${s} ${r2.hint ? import_picocolors2.default.dim(`(${r2.hint})`) : ""}` : i2 === "submitted" ? `${import_picocolors2.default.dim(s)}` : `${import_picocolors2.default.dim(F)} ${import_picocolors2.default.dim(s)}`;
  };
...
${b2(this.state)}  ${t.message}
`, i2 = (s, c3) => {
      const a2 = this.value.includes(s.value);
      return c3 && a2 ? n2(s, "active-selected") : a2 ? n2(s, "selected") : n2(s, c3 ? "active" : "inactive");
    };
    switch (this.state) {
      case "submit":
        return `${r2}${import_picocolors2.default.gray(o2)}  ${this.options.filter(({ value: s }) => this.value.includes(s)).map((s) => n2(s, "submitted")).join(import_picocolors2.default.dim(", ")) || import_picocolors2.default.dim("none")}`;
      case "cancel": {
        const s = this.options.filter(({ value: c3 }) => this.value.includes(c3)).map((c3) => n2(c3, "cancelled")).join(import_picocolors2.default.dim(", "));
        return `${r2}${import_picocolors2.default.gray(o2)}  ${s.trim() ? `${s}
${import_picocolors2.default.gray(o2)}` : ""}`;
      }
      case "error": {
...
`);
        return `${r2 + import_picocolors2.default.yellow(o2)}  ${G2({ options: this.options, cursor: this.cursor, maxItems: t.maxItems, style: i2 }).join(`
${import_picocolors2.default.yellow(o2)}  `)}
${s}
`;
      }
      default:
        return `${r2}${import_picocolors2.default.cyan(o2)}  ${G2({ options: this.options, cursor: this.cursor, maxItems: t.maxItems, style: i2 }).join(`
${import_picocolors2.default.cyan(o2)}  `)}
${import_picocolors2.default.cyan(d2)}
`;
    }
...
var M2 = { message: (t = "", { symbol: n2 = import_picocolors2.default.gray(o2) } = {}) => {
  const r2 = [`${import_picocolors2.default.gray(o2)}`];
  if (t) {
    const [i2, ...s] = t.split(`
`);
    r2.push(`${n2}  ${i2}`, ...s.map((c3) => `${import_picocolors2.default.gray(o2)}  ${c3}`));
  }
...
var Y2 = ({ indicator: t = "dots" } = {}) => {
  ...
  let s, c3, a2 = false, l2 = "", $3, g2 = performance.now();
  const p2 = (m2) => {
...
`);
    ...
    a2 = true, s = fD(), l2 = R2(m2), g2 = performance.now(), process.stdout.write(`${import_picocolors2.default.gray(o2)}
`);
    let h3 = 0, w2 = 0;
    j2(), c3 = setInterval(() => {
      if (i2 && l2 === $3) return;
...
var Ce = async (t, n2) => {
  const r2 = {}, i2 = Object.keys(t);
  for (const s of i2) {
    const c3 = t[s], a2 = await c3({ results: r2 })?.catch((l2) => {
      throw l2;
    });
    if (typeof n2?.onCancel == "function" && pD(a2)) {
      r2[s] = "canceled", n2.onCancel({ results: r2 });
      continue;
    }
    r2[s] = a2;
  }
